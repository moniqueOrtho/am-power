...
<crud-table
    :info="{{ Js::from([
        'editTitleObject' => 'permission',
        'succesMessageObject' => 'permission',
        'deleteMessageObject'=> 'permission'
    ])}}"
    request="{{request()->route()->uri}}"
    :headers=" {{ Js::from( [
            [ 'text' => '#', 'value' => 'rank'],
            [ 'text' => '', 'value' => 'data-table-expand'],
            [ 'text' => trans_choice('site.permissions', 1), 'value' => 'permission'],
    ...
    :labels="{{ Js::from( [
        ...
        'newItem' => trans_choice('site.new i', 2) . " " . trans_choice('site.permissions', 1),
